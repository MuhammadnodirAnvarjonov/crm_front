    ...
    <div class="p-4 md:p-6 bg-white rounded-3xl h-full shadow-xl border border-gray-100 flex flex-col">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 gap-4">
            ...
            <h2 class="text-2xl font-bold text-gray-800 flex items-center gap-2">
                <span>{{ $t('suppliers') || 'Ta\'minotchilar' }}</span>
                <span
        ...
        <ConfirmModal v-if="showConfirmModal" :show="showConfirmModal" :title="$t('delete')"
            :message="`${itemToDelete?.name} ta'minotchisini o‘chirishni tasdiqlaysizmi?`" confirm-text="Ha, o‘chirish"
...
const columns = [
    ...
    { key: "phone", label: t('phone') || 'Telefon', class: "text-gray-600" },
    { key: "comment", label: t('comment') || 'Izoh', class: "text-gray-500 italic" },
